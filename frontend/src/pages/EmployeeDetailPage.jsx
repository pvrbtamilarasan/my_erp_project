               ...
               <TabPanel value={tabValue} index={2}>
                    <Paper elevation={0} sx={{p: {xs: 1, sm: 2}}}>
                       ...
                       <Stack spacing={1.25}>
                            ...
                            <Typography variant="body1" sx={{ display: 'flex', alignItems: 'baseline' }}> <Box component="span" sx={{ fontWeight: 500, width: '160px', flexShrink: 0, color: 'text.secondary', pr: 1 }}>Department</Box>: <Box component="span" sx={{ pl: 1 }}>{employee.department || 'N/A'}</Box> </Typography>
